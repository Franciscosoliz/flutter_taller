...
class AppColors {
  ...
  // ── Estado de la Orden de Trabajo (Taller) ────────────────
  static const Color statusPending    = Color(0xFFF59E0B); // En espera de revisión
  static const Color statusInProcess  = Color(0xFF3B82F6); // En reparación/mantenimiento
  static const Color statusReady      = Color(0xFF8B5CF6); // Listo para retirar
  static const Color statusDelivered  = Color(0xFF22C55E); // Vehículo entregado al cliente
  static const Color statusCancelled  = Color(0xFFEF4444); // Orden cancelada
