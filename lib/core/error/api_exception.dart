...
class ApiException implements Exception {
  ...
  factory ApiException.fromDioError(DioException error) {
    ...
    if (response?.data == null) {
      return ApiException(
        error.message ?? 'Error de conexión con el taller mecánico',
        statusCode: code,
      );
    }
    ...
    // Mapa de errores de campo devueltos por el backend
    if (data is Map<String, dynamic>) {
      ...
      // Captura errores específicos por campo (ej. placa, cliente, repuesto, etc.)
      ...
      return ApiException(
        firstMessage ?? 'Error de validación en los datos del taller',
        statusCode: code,
