...
// ── Interceptor de Autenticación Taller Mecánico ──────────────
class AuthInterceptor extends Interceptor {
  ...
  void onError(DioException err, ErrorInterceptorHandler handler) async {
    ...
    // Solo actuar en 401 (No autorizado) y si no es el endpoint de refresh
    ...
    // Evitar bucle infinito si la reintentada vuelve a fallar
    ...
    // Intentar renovar el token del taller
